...
async function genLogoPrompt() {
  ...
  try {
    ...
    showText("logo-prompt-result", promptTxt, "Stable Diffusion XL Prompt");
  } catch (e) {
...
async function genLogo() {
  ...
  try {
    const res = await post("/api/generate-logo", { brand_name, industry, style_keywords, description, minimalism, complexity, vibrancy });
