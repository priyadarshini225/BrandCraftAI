...
filepath = r'c:\Users\devil\OneDrive\Desktop\BrandCraftAI\frontend\js\branding.js'
...
if os.path.exists(filepath):
    ...
    content = re.sub(r'\btext-gray-200\b', 'text-gray-700', content)
    content = re.sub(r'\btext-gray-300\b', 'text-gray-600', content)
    content = re.sub(r'\btext-gray-400\b', 'text-gray-500', content)
    content = re.sub(r'\btext-gray-500\b', 'text-gray-500', content)
    content = re.sub(r'\btext-slate-[34]00\b', 'text-gray-600', content)
    ...
    content = re.sub(r'#7c3aed', '#FF5F6D', content)
    content = re.sub(r'#06b6d4', '#F4A0A0', content)
    content = re.sub(r'#ec4899', '#F7C5A0', content)
